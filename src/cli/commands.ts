...
Usage:
  ...
  apple-health-mcp-server onboarding                     Print the shared Delx Wellness onboarding flow as JSON (+ TTY summary on stderr)
  apple-health-mcp-server onboarding --pt-BR             Onboarding flow in Brazilian Portuguese
