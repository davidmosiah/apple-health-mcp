...
export function buildPrivacyAudit() {
  ...
  return {
    ...
    notes: [
      ...
      "Use setup --auto-import to copy the newest local export into ~/.apple-health-mcp/exports with 0600 permissions.",
      "Tools return bounded records only when structured/raw mode is selected; do not paste export.xml into chat.",
