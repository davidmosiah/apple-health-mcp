...
Contributions are welcome, especially around Apple Health export parsing, privacy-safe summaries, tests, docs and agent setup examples.
...
- Keep the project explicitly unofficial and unaffiliated with Apple.
- Never commit Apple Health exports, generated health data or local user files.
