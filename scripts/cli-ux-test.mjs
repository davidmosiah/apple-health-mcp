...
const home = mkdtempSync(join(tmpdir(), 'apple-health-mcp-cli-'));
...
try {
  ...
  assert.match(help.stdout, /APPLE_HEALTH_EXPORT_PATH/);
  ...
  assert.match(readFileSync(payload.config_path, 'utf8'), /APPLE_HEALTH_EXPORT_PATH/);
